...
\begin{equation*}
	\begin{tabular}{c||cccc}
		fermion gauge rep. & number of zero-modes & spin of zero-modes& spin of monopole & flavor rep.\\
		\hline
		$\bm{2}$ & $1$ & $0$ & $0$ & spinor\\
		$\bm{3}$ & $2$ & $\tfrac{1}{2}$ & \\
...
there is a $w_2(TM_4)\beta w_2(SU(2)_{\text{gauge}})$ anomaly for a fermion in $\bm{4}$ charged under
\begin{equation*}
...
\end{equation*}
Therefore, by breaking $SU(2)_{\text{flavor}}$ to $U(1)_{\text{flavor}}$
and examining the charge of the corresponding monopole under the remaining gauge group,
one might be able to find out that there is a similar problem,
which implies the existence of $w_2\beta w_2$ anomaly in the first place as desired.
...
since there are monopoles characterized by
\begin{equation*}
	\pi_2\left(
